...
const char* Flags_SCENARIO_Names[] = {
	"SCF_NULL", // 0x80000000 (@ 0x0)
	"SCF_R104_EVENT_4", // 0x40000000 (@ 0x0)
	"SCF_R110_FLOOR_MOVE", // 0x20000000 (@ 0x0)
	"SCF_ACTIVATOR_SP_MES", // 0x10000000 (@ 0x0)
	"SCF_BLUE_HERB_MES", // 0x8000000 (@ 0x0)
	"SCF_R102_VIRUS_OCCUR", // 0x4000000 (@ 0x0)
	...
	"SCF_R117_FIND_ASHLEY", // 0x100000 (@ 0x0)
	...
	"SCF_R103_CLOSE_COVER", // 0x20 (@ 0x0)
	"SCF_R103_ITEM_IN_CESSPIT", // 0x10 (@ 0x0)
	...
	"SCF_R104_MEET_MERCHANT", // 0x20000000 (@ 0x4)
	...
	"SCF_CONTACT_MERCHANT", // 0x400000 (@ 0x4)
	"SCF_R10E_STOCK_DAY", // 0x200000 (@ 0x4)
	"SCF_R10E_STOCK_NIGHT", // 0x100000 (@ 0x4)
	"SCF_R108_OPERATOR", // 0x80000 (@ 0x4)
	"SCF_R204_ASHLEY_SPLIT", // 0x40000 (@ 0x4)
	"SCF_R11C_OPERATOR", // 0x20000 (@ 0x4)
	"SCF_ST3_IN", // 0x10000 (@ 0x4)
	"SCF_ST1_SUB_PERFECT", // 0x8000 (@ 0x4)
	"SCF_R104_MERCHANT_MARK", // 0x4000 (@ 0x4)
	...
	"SCF_R332_BOSS_DIE", // 0x200 (@ 0x4)
	"SCF_ADA_COUNT_DOWN_START", // 0x100 (@ 0x4)
	"SCF_ST3_COUNT_DOWN_START", // 0x80 (@ 0x4)
	"SCF_R213_ASHLEY_LOST", // 0x40 (@ 0x4)
	"SCF_R317_LEON_WOUND", // 0x20 (@ 0x4)
	"SCF_R120_EVENT_CANCEL", // 0x10 (@ 0x4)
	"SCF_R22C_BONUS_1", // 0x8 (@ 0x4)
	"SCF_R22C_BONUS_2", // 0x4 (@ 0x4)
	"SCF_R22C_BONUS_3", // 0x2 (@ 0x4)
	"SCF_R22C_BONUS_4", // 0x1 (@ 0x4)
	"SCF_R321_HERI_DOWN", // 0x80000000 (@ 0x8)
	"SCF_R329_ASHLEY_HELP", // 0x40000000 (@ 0x8)
	"SCF_R405_ADA_GAME_INIT", // 0x20000000 (@ 0x8)
	"SCF_R31C_TOWER_EXPLODE", // 0x10000000 (@ 0x8)
	"SCF_R206_ASHLEY_GAME", // 0x8000000 (@ 0x8)
	"SCF_R201_SET_3OBJ", // 0x4000000 (@ 0x8)
	"SCF_R229_IN", // 0x2000000 (@ 0x8)
	"SCF_R225_IN", // 0x1000000 (@ 0x8)
	"SCF_R226_IN", // 0x800000 (@ 0x8)
	"SCF_R300_00", // 0x400000 (@ 0x8)
	"SCF_R303_IN", // 0x200000 (@ 0x8)
	"SCF_R304_00", // 0x100000 (@ 0x8)
	"SCF_R30C_ASHLEY_SCREAM", // 0x80000 (@ 0x8)
	"SCF_R309_GET_KEY", // 0x40000 (@ 0x8)
	"SCF_R30C_SAVE_ASHLEY", // 0x20000 (@ 0x8)
	"SCF_R317_KNIFE_BATTLE", // 0x10000 (@ 0x8)
	"SCF_R31A_IN", // 0x8000 (@ 0x8)
	"SCF_R31B_U3", // 0x4000 (@ 0x8)
	"SCF_R31C_IN", // 0x2000 (@ 0x8)
	"SCF_R31C_OPEN_DOOR", // 0x1000 (@ 0x8)
	"SCF_R330_END_OPE", // 0x800 (@ 0x8)
	"SCF_R332_KEY_GET", // 0x400 (@ 0x8)
	"SCF_ST3_COUNT_DOWN_DIE", // 0x200 (@ 0x8)
	"SCF_KEY_LOCK", // 0x100 (@ 0x8)
	"SCF_R204_MERCHANT_MOVE", // 0x80 (@ 0x8)
	"SCF_OMAKE_MAP", // 0x40 (@ 0x8)
	"SCF_R100_OFFICERS_FOUND", // 0x20 (@ 0x8)
	"SCF_R21A_R21B_IN", // 0x10 (@ 0x8)
	"SCF_ADA_SHOP_1ST", // 0x8 (@ 0x8)
	"SCF_ADA_SHOP_2ND", // 0x4 (@ 0x8)
	"SCF_ASHLEY_PARA_OFF", // 0x2 (@ 0x8)

	// TODO: SCF_FILE_07_GET etc (they start at 167, would need to add a ton of placeholders here...)
};
