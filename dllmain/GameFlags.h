...
enum class Flags_SCENARIO
{
	...
	SCF_R316_IN = 184, // 0x400000 (@ 0x14)
	SCF_R102_MEET_MERCHANT = 185, // 0x200000 (@ 0x14)
	SCF_PS2_ADA_MAP = 186, // 0x100000 (@ 0x14)
	SCF_R502_DOOR = 187, // 0x80000 (@ 0x14)
	SCF_R502_GREEN_GEMS = 188, // 0x40000 (@ 0x14)
	SCF_R502_EMBLEM = 189, // 0x20000 (@ 0x14)
	SCF_R508_ENTER = 190, // 0x10000 (@ 0x14)
	SCF_R508_STEEL_KEY = 191, // 0x8000 (@ 0x14)
	SCF_R508_BOOT_GONDOLA = 192, // 0x4000 (@ 0x14)
	SCF_R507_EVENT = 193, // 0x2000 (@ 0x14)
	SCF_R50B_KEY = 194 // 0x1000 (@ 0x14)
};
